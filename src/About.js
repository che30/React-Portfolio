    ...
    <div>
     <div className="abt__parent_section">
        <div className="abt__section">
            <h1 className="text-white header__one font-Nunito-bold">Hi! I'm CHE NSOH </h1>
            <h2 className="full__stack header__two font-Nunito-medium">A Full-stack Developer</h2>
            <p className="header__three font-Nunito-light">I can help you build a product, feature or website. Look through 
            ...
            <div className="bg-orange d-flex ">
                <p className="font-Nunito-light" >Feel free to check my work on social media</p>
                <div className="d-flex font-Nunito-bold">
